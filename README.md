...
The folder "wiki" is a copy of the article in markdown language that can be used to accompany any Stamps documentation in your VFX studio's internal wiki.
