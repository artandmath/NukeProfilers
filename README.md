...
- Open the nukescript /nukescripts/GenerateSprites.nk, re-link the file *"#introductions_(2015) (Original).mp4"* from Vimeo at the top of the NodeGraph and render all write nodes, observing the render order.
