...
- Open the nukescript /nukescripts/GenerateSprites.nk, re-link the .mp4 from Vimeo at the top of the NodeGraph and render all write nodes, observing the render order.
