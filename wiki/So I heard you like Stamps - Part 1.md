...
It will be interesting to investigate to see if Topdown rendering has improved in Nuke 14 & 15. The decrease in Topdown performance rather than the proposed perforance increase may well also be a case of these tests being run on ancient hardware.
